...
})({"hThME":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "17fa5c8c9ea9eedc";
"use strict";
...
},{}],"6GyBZ":[function(require,module,exports) {
(function(global, factory) {
   ...
   */ var scrollingClassTimeout = {
    ...
    EventManager.prototype.eventElement = function eventElement(element) {
        var ee1 = this.eventElements.filter(function(ee) {
            return ee.element === element;
        })[0];
        if (!ee1) {
            ee1 = new EventElement(element);
            this.eventElements.push(ee1);
        }
        return ee1;
    };
    ...
    var PerfectScrollbar = function PerfectScrollbar(element, userSettings) {
        ...
        this.scrollbarXRail = div1(cls.element.rail('x'));
        element.appendChild(this.scrollbarXRail);
        this.scrollbarX = div1(cls.element.thumb('x'));
        ...
        this.scrollbarYRail = div1(cls.element.rail('y'));
        element.appendChild(this.scrollbarYRail);
        this.scrollbarY = div1(cls.element.thumb('y'));
...
},{}]},["hThME","6GyBZ"], "6GyBZ", "parcelRequiredfe0")

//# sourceMappingURL=index.9ea9eedc.js.map
